...
-- happy --ghc --coerce --array --info parser.y
-- ghci parser.hs -o parser.o Env.hs PrettyPrinter.hs StaticSemantic.hs TypeSys.hs ../bin/AbsGrammar.hs ../bin/ErrM.hs Errors.h
...
%attribute return { ([String], [String]) } -- ([Instruction], [Error])
%attribute env  { E.Env }
...
Integer :: { Integer }
Integer  : L_integ  { $$.type = T.IntegerType }

Double  :: { Double }
Double   : L_doubl  { $$.type = T.RealType }

Char    :: { Char }
Char     : L_charac { $$.type = T.CharType }
...
Program :: { Program }
Program : ProgramKW Ident ';' BlockWithDecl '.' { 
  AbsGrammar.ProgramStart $1 $2 $4;
  $$.return = ([], [])
  }
...
VariableDeclBlock : ListIdent ':' Type InitAssign { 
  AbsGrammar.VariableDeclarationInsideBlock $1 $3 $4;
  -- $$.errors = SS.checkErrorOnAssignment $3.type $4.type;
}

InitAssign :: { InitAssign }
InitAssign : {- empty -} { AbsGrammar.InitAssign1 }
           | '=' RightExp { 
              AbsGrammar.InitAssign2 $2;
            }
...
Type : 
  BaseType { 
    AbsGrammar.TypeBaseType $1;
    -- $$.type = $1.type;
    -- putStrLn $ show $ $$.type;
  }
  | CompositeType { 
    AbsGrammar.TypeCompositeType $1;
    -- $$.type = $1.type; 
    -- putStrLn $ show $ $$.type;
  }
...
BaseType : 
  IntKW { 
    AbsGrammar.BaseTypeIntKW $1;
    -- $$.type = T.IntegerType;
  } 
  | RealKW { 
    AbsGrammar.BaseTypeRealKW $1;
    -- $$.type = T.RealType;
  }
  | CharKW { 
    AbsGrammar.BaseTypeCharKW $1;
    -- $$.type = T.CharType;    
  }
  | BoolKW { 
    AbsGrammar.BaseTypeBoolKW $1;
    -- $$.type = T.BooleanType;
  }
  | StringKW { 
    AbsGrammar.BaseTypeStringKW $1;
    -- $$.type = T.StringType;
  }
