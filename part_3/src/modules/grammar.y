...
%token
  ...
  ']' { PT (Pn _ r c) (TS _ 21) }
  '^' { PT (Pn _ r c) (TS _ 22) }
  'and' { PT (Pn _ r c) (TS _ 23) }
  'array' { PT (Pn _ r c) (TS _ 24) }
  'begin' { PT (Pn _ r c) (TS _ 25) }
  'boolean' { PT (Pn _ r c) (TS _ 26) }
  'char' { PT (Pn _ r c) (TS _ 27) }
  'const' { PT (Pn _ r c) (TS _ 28) }
  'div' { PT (Pn _ r c) (TS _ 29) }
  'do' { PT (Pn _ r c) (TS _ 30) }
  'else' { PT (Pn _ r c) (TS _ 31) }
  'end' { PT (Pn _ r c) (TS _ 32) }
  'false' { PT (Pn _ r c) (TS _ 33) }
  'for' { PT (Pn _ r c) (TS _ 34) }
  'forward' { PT (Pn _ r c) (TS _ 35) }
  'function' { PT (Pn _ r c) (TS _ 36) }
  'if' { PT (Pn _ r c) (TS _ 37) }
  'integer' { PT (Pn _ r c) (TS _ 38) }
  'mod' { PT (Pn _ r c) (TS _ 39) }
  'not' { PT (Pn _ r c) (TS _ 40) }
  'of' { PT (Pn _ r c) (TS _ 41) }
  'or' { PT (Pn _ r c) (TS _ 42) }
  'procedure' { PT (Pn _ r c) (TS _ 43) }
  'program' { PT (Pn _ r c) (TS _ 44) }
  'readChar' { PT (Pn _ r c) (TS _ 45) }
  'readInt' { PT (Pn _ r c) (TS _ 46) }
  'readReal' { PT (Pn _ r c) (TS _ 47) }
  'readString' { PT (Pn _ r c) (TS _ 48) }
  'real' { PT (Pn _ r c) (TS _ 49) }
  'repeat' { PT (Pn _ r c) (TS _ 50) }
  'string' { PT (Pn _ r c) (TS _ 51) }
  'then' { PT (Pn _ r c) (TS _ 52) }
  'to' { PT (Pn _ r c) (TS _ 53) }
  'true' { PT (Pn _ r c) (TS _ 54) }
  'until' { PT (Pn _ r c) (TS _ 55) }
  'var' { PT (Pn _ r c) (TS _ 56) }
  'while' { PT (Pn _ r c) (TS _ 57) }
  'writeChar' { PT (Pn _ r c) (TS _ 58) }
  'writeInt' { PT (Pn _ r c) (TS _ 59) }
  'writeReal' { PT (Pn _ r c) (TS _ 60) }
  'writeString' { PT (Pn _ r c) (TS _ 61) }
  L_ident  { PT (Pn _ r c) (TV _) }
  L_integ  { PT (Pn _ r c) (TI _) }
  L_doubl  { PT (Pn _ r c) (TD _) }
  L_charac { PT (Pn _ r c) (TC _) }
  L_quoted { PT (Pn _ r c) (TL _) }

%%

Ident   :: { Ident }
Ident    : L_ident  { 
  let (x,y) = tokenLineCol $1 in
  --let (PT (Pn _ r c) t) = $1 in
    AbsGrammar.Ident "test" (x::Int) (y::Int) 
}
...
Statement : BlockExec { AbsGrammar.StatementBlock $1 }
          ...
          | 'repeat' ListStatement 'until' RightExp { AbsGrammar.StatementRepeatUntil $2 $4 }
